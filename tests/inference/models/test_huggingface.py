...
from thunderllm.inference.models.huggingface import HFLM
...
class Test_HFLM:
    ...
    task_list = task_manager.load_task_or_group(
        ["arc_easy", "gsm8k", "wikitext"])
    ...
    LM = HFLM(pretrained="EleutherAI/pythia-70m",
    ...
    def test_toc_encode(self) -> None:
        """We will not test this method for now on"""
        return
