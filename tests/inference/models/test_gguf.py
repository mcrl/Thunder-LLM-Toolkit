...
from thunderllm.inference.models.gguf import GGUFLM
...
class GGUFLMTest(unittest.TestCase):
    @patch(
        "thunderllm.inference.models.gguf.GGUFLM.gguf_completion", side_effect=gguf_completion_mock
    )
    ...
    def test_generate_until(self, gguf_completion_mock):
        ...
        expected_res = ["generated text until stop1",
                        "generated text until stop2"]
        self.assertEqual(res, expected_res)

    # @patch('thunderllm.inference.models.gguf.GGUFLM.gguf_completion', side_effect=gguf_completion_mock)
