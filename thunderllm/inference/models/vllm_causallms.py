...
from thunderllm.inference.api.model import TemplateLM
from thunderllm.inference.api.registry import register_model
...
class VLLM(TemplateLM):
    ...
    def _model_generate(
        ...
        **kwargs,
        ...
        if self.data_parallel_size > 1:
            ...
            requests = [list(x) for x in distribute(
                self.data_parallel_size, requests)]
            inputs = ((self.model_args, sampling_params, req)
                      for req in requests)
        ...
        for chunk in chunks:
            ...
            for cache_key, context_enc, continuation_enc in chunk:
                ...
                ctxlen = len(context_enc) - max(
                    0, len(context_enc) + len(continuation_enc) -
                    (self.max_length)
                )
    ...
    def modify_gen_kwargs(kwargs: dict) -> dict:
        ...
        # hf defaults
        kwargs["skip_special_tokens"] = kwargs.get(
