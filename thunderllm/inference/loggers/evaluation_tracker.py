...
class GeneralConfigTracker:
    ...
    def _get_model_name(model_args: str) -> str:
        ...
        prefixes = ["peft=", "delta=", "pretrained=",
                    "model=", "path=", "engine="]
    ...
    def log_experiment_args(
        ...
        self.chat_template_sha = hash_string(
            chat_template) if chat_template else None
    ...
    def save_results_aggregated(
        ...
        if self.output_path:
            try:
                ...
                file_results_aggregated.open(
                    "w", encoding="utf-8").write(dumped)
